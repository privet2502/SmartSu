...
<template>
  <article class="block">
    <address class="address" :class="{ mobileHide: isHideInfo }">
      ...
      <ul>
        <li>
          ...
          <a href="tel:+77717652986">+7 (771) 765-29-86</a>
        </li>
        <li>
          <figure>
            <img src="@/assets/svg/phone-contact.svg" alt="phone" />
          </figure>
          <p><a href="tel:+77273132403">+7 (727) 313-24-03</a> вн. 202</p>
        </li>
        <li>
          <figure>
    ...
    <form action="submit" class="form" @submit.prevent="sendEmail()">
      ...
      <div class="form-radio">
        ...
        <div class="form-radio-layouts">
          <div class="form-radio-item">
            <input type="radio" name="contact-method" id="call" value="call" v-model="object.choosen" />
            <label for="call">
          ...
          <div class="form-radio-item">
            <input type="radio" name="contact-method" id="whatsapp" value="whatsapp" v-model="object.choosen" />
            <label for="whatsapp">
      ...
      <button class="consultation-btn" type="submit" :disabled="loading" @click="addToast()">
